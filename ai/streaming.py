...
from ai.llm_models.gpt_4o import gpt_4o  # Corrected import to match the actual module structure
...
async def stream_answer(query: str, session_id: str, user_id: str):
    ...
    top_chunks = await vector_store.search(query_embedding, top_k=5)

    # Step 3: Build prompt with retrieved context
    context = "\n\n".join([chunk["text"] for chunk in top_chunks])
    prompt = f"Answer the following question based on the context below:\n\nContext:\n{context}\n\nQuestion:\n{query}"

    # Step 4: Call gpt_4o with stream=True
